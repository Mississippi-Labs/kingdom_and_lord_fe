...
<template>
  ...
  <div class="list">
    <n-card v-for="city in cityList" :key="city.id" :title="`${city.name} (${city.level})`" style="width: 200px;margin: 0 16px 16px 0;">
      <n-button strong secondary @click="upgradeFun(city)">upgrade</n-button>
    </n-card>
  </div>
