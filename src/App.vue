...
import { cityList, resource } from './libs/data'
...
<template>
  <div class="content">
    ...
    <div class="main">
      ...
      <div class="main-r">
        <div class="r-item">
          <div class="r-title">GrowthRate:</div>
